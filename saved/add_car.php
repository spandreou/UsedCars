...
<div class="container mt-5">
  ...
  <div class="mb-3">
    ...
    <input class="form-control" type="number" name="first_license_year"
           min="1950" max="<?= date('Y') ?>" required>
  </div>

  <div class="mb-3">
    <label class="form-label">Τιμή (€)</label>
    <input class="form-control" type="number" step="0.01" name="price" min="0.01" required>
  </div>
  ...
  <button class="btn btn-primary w-100">Καταχώρηση</button>
</form>
      ...
      <!-- Η φόρμα σου (ίδια όπως την έχεις) -->
